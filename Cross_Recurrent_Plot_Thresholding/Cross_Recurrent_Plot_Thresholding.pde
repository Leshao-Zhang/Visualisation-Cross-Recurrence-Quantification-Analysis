...
void setup(){
  ...
  rm = new RecurrentMatrix( PreProcess.downSample(PreProcess.dimension(lorenz.getTrajectory(),0),5),
                            PreProcess.downSample(PreProcess.dimension(lorenz2.getTrajectory(),0),5),
                            dim,lag,radius);
